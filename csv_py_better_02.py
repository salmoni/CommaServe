...
def ReadWholeCSV(fileName, delims=",", quotes='"', lineEnd=None, headerRow=False, startRow=0, encoding="utf-8"):
	...
	for char in data: # iterate, iterate...
		if maybeLineEnding == True and char == lineEnd[1]: # Oh! Windows line ending second character match!
		...
		elif len(lineEnd) == 1 and char == lineEnd: # Non-Windows new line character?
